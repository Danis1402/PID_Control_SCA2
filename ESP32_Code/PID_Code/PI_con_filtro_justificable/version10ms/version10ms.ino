...
const int   INTERVALO_MS = 10;   // Ts = 100ms (0.1s)
float setpoint = 1500;             // Velocidad deseada en RPM
...
float rpmFiltrada = 0;
const float alpha = 0.3; // Factor de filtrado (0.1 = mucho filtro, 0.9 = poco filtro, 1 = no hay filtro)
